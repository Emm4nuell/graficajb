...
export const defaultCreateVacancy: CreateVacancyType = {
  titulo: "",
  descricao: "",
  cargo: "",
  atividades: "",
...
export const validationCreateVacancyPayload = z.object({
  titulo: z
    .string()
...
export type ValidationCreateVacancy = z.infer<typeof validationCreateVacancyPayload>;
